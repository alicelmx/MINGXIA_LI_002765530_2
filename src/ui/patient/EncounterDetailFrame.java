 ...
 * @author limingxia
 */
public class EncounterDetailFrame extends javax.swing.JFrame {
     ...
     */
    public EncounterDetailFrame() {
        initComponents();
    }

    public EncounterDetailFrame(Encounter selectedEncounter) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EncounterDetailFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EncounterDetailFrame().setVisible(true);
            }
        });
    }
